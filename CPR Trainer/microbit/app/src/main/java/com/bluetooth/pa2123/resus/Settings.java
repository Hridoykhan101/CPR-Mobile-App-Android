...
public class Settings {
    ...
    private int startingTimer = 60000;
    ...
    private static final String MEASUREMENT = "measure";
    private static final String STARTING_TIMER = "startingTimer";
    ...
    public void save(Context context) {
        ...
        editor.putString(MEASUREMENT, measure);
        editor.putInt(STARTING_TIMER, startingTimer);
    ...
    public void restore(Context context) {
        ...
        measure = sharedPref.getString(MEASUREMENT,"cm");
        startingTimer = sharedPref.getInt(STARTING_TIMER,60000);
    ...
    public String getMeasurement() { return measure;}

    public void setMeasurement(String measurement) {
        this.measure = measurement;
    }

    public int getStartingTimer() { return startingTimer;}

    public void setStartingTimer(int timer) {
